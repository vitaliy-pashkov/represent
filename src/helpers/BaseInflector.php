...
class BaseInflector
	...
	public static function singular($words)
		{
		$words = self::humanize($words);

		$words = explode(' ', $words);
		$singularWords = [];
		foreach ($words as $word)
			{
			$singularWords[] = self::singularize($word);
			}
		return implode('_', $singularWords);
		}
	...
	public static function camelize($word)
		{
		return str_replace(' ', '', ucwords(preg_replace('/[^\pL\pN]+/u', ' ', $word)));
		}
